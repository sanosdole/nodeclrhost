...
struct JsHandle
{
    ...
    static JsHandle Undefined() {
        return JsHandle(JsType::Undefined, nullptr);
    }
    ...
    {
        function_value_ = new Napi::Reference<Napi::Function>(Napi::Persistent(func));
